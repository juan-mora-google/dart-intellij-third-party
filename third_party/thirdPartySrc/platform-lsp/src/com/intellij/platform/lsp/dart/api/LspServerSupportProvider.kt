...
import com.intellij.platform.lsp.dart.api.lsWidget.LspServerWidgetItem
...
interface LspServerSupportProvider {
  ...
  companion object {
    val EP_NAME: ExtensionPointName<LspServerSupportProvider> = create("com.intellij.platform.lsp.dart.serverSupportProvider")
  }
}
