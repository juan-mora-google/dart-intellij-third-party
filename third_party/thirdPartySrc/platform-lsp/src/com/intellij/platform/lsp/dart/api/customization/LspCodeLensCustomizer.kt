...
package com.intellij.platform.lsp.dart.api.customization
...
open class LspCodeLensSupport : LspCodeLensCustomizer() {
   ...
   * The utility functions [com.intellij.platform.lsp.dart.api.Lsp4jService.extractLocationsFromJson] and
   * [com.intellij.platform.lsp.dart.util.navigateOrShowPopup] are provided to handle the most common cases.
   ...
   * @see com.intellij.platform.lsp.dart.api.Lsp4jService.extractLocationsFromJson
   * @see com.intellij.platform.lsp.dart.util.navigateOrShowPopup
   */
