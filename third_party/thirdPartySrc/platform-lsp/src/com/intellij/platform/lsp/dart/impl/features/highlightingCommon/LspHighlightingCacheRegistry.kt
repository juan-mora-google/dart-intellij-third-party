package com.intellij.platform.lsp.dart.impl.features.highlightingCommon
...
import com.intellij.platform.lsp.dart.impl.features.codeLens.LspCodeLensCache
import com.intellij.platform.lsp.dart.impl.features.folding.LspFoldingRangeCache
import com.intellij.platform.lsp.dart.impl.features.highlighting.DiagnosticAndQuickFixes
import com.intellij.platform.lsp.dart.impl.features.highlighting.LspDocumentLinkCache
import com.intellij.platform.lsp.dart.impl.features.highlighting.LspPublishDiagnosticsCache
import com.intellij.platform.lsp.dart.impl.features.highlighting.LspPullDiagnosticsCache
import com.intellij.platform.lsp.dart.impl.features.highlighting.LspSemanticTokensCache
import com.intellij.platform.lsp.dart.impl.features.highlighting.copyDiagnosticWithRange
import com.intellij.platform.lsp.dart.impl.features.inlayHint.LspInlayHintsCache
import com.intellij.platform.lsp.dart.impl.features.inlayHintColor.LspDocumentColorCache
import com.intellij.platform.lsp.dart.util.getLsp4jRange
...
internal class LspHighlightingCacheRegistry(private val lspServer: LspServerImpl) {
   ...
   * [LspIntentionAction][com.intellij.platform.lsp.dart.api.customization.LspIntentionAction] object at this moment,
   * but clients shouldn't care about that. For curious: see [LspQuickFixSet][com.intellij.platform.lsp.dart.impl.features.quickFix.LspQuickFixSet].
   */
